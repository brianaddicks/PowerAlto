...
```
New-PaPanoramaConfig [[-PrimaryServer] <String>] [[-SecondaryServer] <String>] [[-ReceiveTimeout] <Int32>]
 [[-SendTimeout] <Int32>] [[-RetryCount] <Int32>] [-DisableDeviceMonitoring] [<CommonParameters>]
```
